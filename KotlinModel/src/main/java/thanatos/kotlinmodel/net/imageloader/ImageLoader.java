package thanatos.kotlinmodel.net.imageloader;
...
import thanatos.kotlinmodel.net.imageloader.utils.BitmapUtils;
import thanatos.kotlinmodel.net.imageloader.utils.CallBack;
import thanatos.kotlinmodel.net.imageloader.utils.ImageCache;
import thanatos.kotlinmodel.net.imageloader.utils.MemeryCache;
...
public class ImageLoader {
    ...
    private static final Semaphore threadSemaphore=new Semaphore(Runtime.getRuntime().availableProcessors());
    ...
    public ImageLoader load(String path, ImageView imageView){
        ...
        getImageHolder();
        if (imageCache==null) throw new NullPointerException("imageCache can not null");
